...
%   arg = DEFAULT_ARG('model_phys') UAV physical model [UAV.Models.Phys]
...
%   arg = DEFAULT_ARG('model_ctrl') UAV control model [UAV.Models.Ctrl]
...
%   arg = DEFAULT_ARG('wz_max') Max heading cmd velocity [rad/s]
...
switch name
    ...
    % Physical model
    case 'model_phys', arg = UAV.Models.Phys();
    ...
    % Control model
    case 'model_ctrl', arg = UAV.Models.Ctrl();
    case 's_qx', arg = -5.0;
    case 's_qy', arg = -5.0;
    case 's_qz', arg = -5.0;
    case 's_az', arg = -5.0;
